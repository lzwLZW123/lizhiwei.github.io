...
export const foots = [
    {txt:"外卖",path:"/main/home",name:"home",icon:"icon-home"},
    {txt:"商家",path:"/main/classify",name:"classify",icon:"icon-goodsfill"},
    {txt:"订单",path:"/main/cart",name:"cart",icon:"icon-shop_car"},
